...
describe('Create Component', () => {
  ...
  describe('Form Submission', () => {
    test.skip('submits the form with valid data', async () => {
      ...
      fireEvent.changeText(screen.getByPlaceholderText('Enter Event Name'), 'Test Event');
    ...
    test.skip('displays an error alert when the form submission fails', async () => {
      (createEvent as jest.Mock).mockRejectedValueOnce(new Error('Error occurred while creating the event'));
      ...
      await waitFor(() => {
        expect(Alert.alert).toHaveBeenCalledWith('Error', 'Error occurred while creating the event');
      });
    });
  });
