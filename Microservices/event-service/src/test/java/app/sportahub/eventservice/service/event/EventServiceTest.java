...
public class EventServiceTest {
    ...
    public void createEventShouldReturnSuccessfulCreation() {
        ...
        assertEquals(eventRequest.location().name(), result.location().getName());
        assertEquals(eventRequest.location().city(), result.location().getCity());
        assertEquals(eventRequest.location().province(), result.location().getProvince());
        assertEquals(eventRequest.location().country(), result.location().getCountry());
